...
public class DiagnosticsOperationsServiceTest {
    ...
    public void testInit() throws Exception {
        ...
        // WHEN
        underTest.init(STACK_ID, diagnosticParameters());
        // THEN
    ...
    public void testCollect() throws Exception {
        ...
        // WHEN
        underTest.collect(STACK_ID, diagnosticParameters());
        // THEN
    ...
    public void testUpload() throws Exception {
        ...
        // WHEN
        underTest.upload(STACK_ID, diagnosticParameters());
        // THEN
    ...
    public void testCleanup() throws Exception {
        ...
        // WHEN
        underTest.cleanup(STACK_ID, diagnosticParameters());
        // THEN
    ...
    public void vmPreflightCheck() throws Exception {
        ...
        // WHEN
        underTest.vmPreflightCheck(STACK_ID, diagnosticParameters());
        // THEN
    ...
    public void applyUnresponsiveNodesCheck() throws Exception {
        ...
        // WHEN
        underTest.applyUnresponsiveHosts(STACK_ID, diagnosticParameters());
        // THEN
    ...
    @Test
    public void testVmDiagnosticsReport() throws Exception {
        // GIVEN
        doNothing().when(usageReporter).cdpVmDiagnosticsEvent(any());
        // WHEN
        underTest.vmDiagnosticsReport("crn", diagnosticParameters());
        // THEN
    ...
    private Set<Node> nodes() {
        ...
        nodes.add(new Node("host1", null, null, null));
        return nodes;
    }
}
