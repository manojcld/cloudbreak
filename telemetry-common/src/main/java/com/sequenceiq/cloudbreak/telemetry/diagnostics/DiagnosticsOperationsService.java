...
public class DiagnosticsOperationsService {
    ...
    public void applyUnresponsiveHosts(Long stackId, DiagnosticParameters parameters)
        ...
        OrchestratorMetadataFilter filter = OrchestratorMetadataFilter.Builder.newBuilder()
                ...
                .build();
        Set<Node> allUnresponsiveNodes = telemetryOrchestrator.collectUnresponsiveNodes(
                orchestratorMetadata.getGatewayConfigs(), orchestratorMetadata.getNodes(), orchestratorMetadata.getExitCriteriaModel());
        Set<String> unresponsiveHosts = allUnresponsiveNodes.stream()
                .filter(filter::apply)
    ...
    private void executeDiagnosticsOperation(Long stackId, DiagnosticParameters parameters, String operationName, DiagnosticsOperationFunction func)
        ...
        OrchestratorMetadataFilter filter = OrchestratorMetadataFilter.Builder.newBuilder()
                ...
                .exlcudeHosts(parameters.getExcludeHosts())
                .build();
        Set<Node> filteredNodes = filter.apply(orchestratorMetadata);
        ...
        if (filteredNodes.isEmpty()) {
            ...
            func.apply(orchestratorMetadata, parameters);
        }
    }
